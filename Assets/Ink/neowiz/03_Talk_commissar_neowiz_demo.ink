...
+ [좋아]
    말을 걸어봐야 겠다. 
    {first_meet_check: ->commissar_talk_start | ->commissar_talk_first}
...
{~함장. 오늘 저녁은 뭔가? |같이 기도 하러 가겠나?}

- trust_commissar >= 50:
{~오! 함장 왔어요? 기다리고 있었어요!|안녕!<br>오늘은 제가 먼저 인사했네요?}
} 
...
- 연구는 아직 진행중이지만,<br>우주신이 이 세상을 창조한 유일무이한 신이라는 것이 현재의 정설이지.
